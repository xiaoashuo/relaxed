...
//
//        // 解析并计算表达式的值
//        String propertyResult = parser.parseExpression(propertyExpression).getValue(context, String.class);
//
//        // 打印结果
...
//
//        // 解析并计算表达式的值
//        String nonStaticMethodResult = parser.parseExpression(nonStaticMethodExpression).getValue(context, String.class);
//
//        // 打印结果
