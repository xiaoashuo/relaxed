...
@Slf4j
@Getter
public class MailGlobalExceptionNotifier implements ExceptionNotifier {
	...
	public MailGlobalExceptionNotifier(String channel, MailSender sender, Set<String> receiveEmails) {
