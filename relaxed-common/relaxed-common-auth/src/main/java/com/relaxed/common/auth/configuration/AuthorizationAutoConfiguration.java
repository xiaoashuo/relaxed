package com.relaxed.common.auth.configuration;

import com.relaxed.common.auth.builder.TokenGrantBuilder;
import com.relaxed.common.auth.builder.TokenGranterProvider;
import com.relaxed.common.auth.configurer.CustomAuthorizationServerConfigurer;
import com.relaxed.common.auth.configurer.CustomWebSecurityConfigurer;
import com.relaxed.common.auth.configurer.JdbcOauth2ClientConfigurer;
import com.relaxed.common.auth.configurer.OAuth2ClientConfigurer;
import com.relaxed.common.auth.exception.CustomAuthenticationEntryPoint;
import com.relaxed.common.auth.exception.CustomWebResponseExceptionTranslator;
import com.relaxed.common.auth.extension.captcha.CaptchaTokenGranter;
import com.relaxed.common.auth.extension.captcha.CaptchaValidator;

import com.relaxed.common.auth.extension.mobile.SmsCodeAuthenticationProvider;
import com.relaxed.common.auth.extension.mobile.SmsCodeValidator;
import com.relaxed.common.auth.util.PasswordUtils;
