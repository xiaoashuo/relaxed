...
import com.relaxed.common.core.util.http.interceptor.GlobalInterceptor;
...
public class HttpConfig {
	 ...
	 */
	final HttpInterceptor.Chain<HttpRequest> requestInterceptors = GlobalInterceptor.INSTANCE
			.getCopiedRequestInterceptor();

	/**
	 * 响应后的拦截器，用于在响应后处理逻辑
	 */
	final HttpInterceptor.Chain<HttpResponse> responseInterceptors = GlobalInterceptor.INSTANCE
			.getCopiedResponseInterceptor();
