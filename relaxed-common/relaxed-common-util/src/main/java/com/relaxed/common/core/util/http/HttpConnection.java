...
public class HttpConnection {
	 ...
	 */
	public com.relaxed.common.core.util.http.Method getMethod() {
		return com.relaxed.common.core.util.http.Method.valueOf(this.conn.getRequestMethod());
	}
	 ...
	 * @return 自己
	 */
	public HttpConnection setMethod(com.relaxed.common.core.util.http.Method method) {
		if (com.relaxed.common.core.util.http.Method.POST.equals(method) //
				|| com.relaxed.common.core.util.http.Method.PUT.equals(method)//
				|| com.relaxed.common.core.util.http.Method.PATCH.equals(method)//
				|| com.relaxed.common.core.util.http.Method.DELETE.equals(method)) {
			this.conn.setUseCaches(false);

			// 增加PATCH方法支持
			if (com.relaxed.common.core.util.http.Method.PATCH.equals(method)) {
	...
	public HttpConnection setHttpsInfo(HostnameVerifier hostnameVerifier, SSLSocketFactory ssf) throws HttpException {
		...
		if (conn instanceof HttpsURLConnection) {
			...
			httpsConn.setHostnameVerifier(
					ObjectUtil.defaultIfNull(hostnameVerifier, DefaultSSLInfo.TRUST_ANY_HOSTNAME_VERIFIER));
	...
	public OutputStream getOutputStream() throws IOException {
		...
		final com.relaxed.common.core.util.http.Method method = getMethod();
		...
		if (method == com.relaxed.common.core.util.http.Method.GET && method != getMethod()) {
			ReflectUtil.setFieldValue(this.conn, "method", com.relaxed.common.core.util.http.Method.GET.name());
		}
	...
	public String toString() {
		...
		// this.conn.getHeaderFields().entrySet()) {
	...
	private HttpURLConnection openHttp() throws IOException {
		...
		if (false == conn instanceof HttpURLConnection) {
			...
			throw new HttpException("'{}' of URL [{}] is not a http connection, make sure URL is format for http.",
					conn.getClass().getName(), this.url);
		}
