package com.relaxed.common.core.util.http.interceptor;

import com.relaxed.common.core.util.http.Chain;
import com.relaxed.common.core.util.http.HttpBase;
...
public interface HttpInterceptor<T extends HttpBase<T>> {
	 ...
	 * @since 5.7.16
	 */
	class Chain<T extends HttpBase<T>>
			implements com.relaxed.common.core.util.http.Chain<HttpInterceptor<T>, Chain<T>> {
