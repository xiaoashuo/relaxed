...
public class MedianAggregateExecutor extends AbstractAggregateExecutor<BigDecimal> {
	...
	public BigDecimal execute(AggregateParam aggregateParam) {
		return modelEventManageService.median(aggregateParam.getModelId(), aggregateParam.getSearchFieldName(),
