...
public class MinAggregateExecutor extends AbstractAggregateExecutor<BigDecimal> {
	...
	public BigDecimal execute(AggregateParam aggregateParam) {
		return modelEventManageService.min(aggregateParam.getModelId(), aggregateParam.getSearchFieldName(),
