package com.relaxed.common.datascope.test.datascope;
...
import com.relaxed.common.datascope.util.SqlParseUtils;
...
class SqlParseTest {
	...
	void assertSql(String sql, String targetSql) {
		assertSql(dataScopeSqlProcessor.parserSingle(sql, dataPermissionHandler.dataScopes()), targetSql);
	}
