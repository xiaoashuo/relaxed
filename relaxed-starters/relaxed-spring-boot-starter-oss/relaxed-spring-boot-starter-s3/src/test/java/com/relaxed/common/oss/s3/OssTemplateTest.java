...
// new FileInputStream(ResourceUtils.getFile(ResourceUtils.CLASSPATH_URL_PREFIX +
// TEST_OBJECT_NAME)));
//
// }
//
...
// String url = ossTemplate.getObjectURL(TEST_BUCKET_NAME, TEST_UPLOAD_OBJECT_NAME, 1,
// HttpMethod.PUT);
// // 断言生成的链接必定包含过期时间字段
// Assertions.assertTrue(url.contains("X-Amz-Expires"));
// System.out.println("URL: " + url);
