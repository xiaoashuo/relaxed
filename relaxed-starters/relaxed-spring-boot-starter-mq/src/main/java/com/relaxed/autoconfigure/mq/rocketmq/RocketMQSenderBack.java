...
// static {
// // 预设值的延迟时间间隔为：1s、 5s、 10s、 30s、 1m、 2m、 3m、 4m、 5m、 6m、 7m、 8m、 9m、 10m、 20m、
// // 30m、 1h、 2h
...
// rocketMQTemplate.syncSend(mqModel.getMQName(),
/// MessageBuilder.withPayload(mqModel.toMessage()).build(), 300000,
...
// .forEach(time -> resultMap.put(Math.abs(delay - time), DELAY_TIME_LEVEL.indexOf(time) +
/// 1));
