...
@NoArgsConstructor
@AllArgsConstructor
public class Fanout2MQ implements AbstractMQ {

	public static final String EXCHANGE_NAME = "exchange-fanout-test";

	public static final String QUEUE_NAME = "queue-fanout-test2";

	/** 内置msg 消息体定义 **/
	private Fanout2MQ.MsgPayload payload;
	...
	public static Fanout2MQ build(List<Long> userIdList) {
		return new Fanout2MQ(new Fanout2MQ.MsgPayload(userIdList));
	}

	/** 解析MQ消息， 一般用于接收MQ消息时 **/
	public static Fanout2MQ.MsgPayload parse(String msg) {
		return JSONUtil.toBean(msg, Fanout2MQ.MsgPayload.class);
	}
	...
	public interface IMQReceiver {
		...
		void receive(Fanout2MQ.MsgPayload payload);
