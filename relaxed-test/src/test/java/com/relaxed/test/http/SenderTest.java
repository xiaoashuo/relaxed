...
import com.relaxed.test.http.custom.CustomSender;
import com.relaxed.test.http.example.create.CreateRequest;
import com.relaxed.test.http.example.create.CreateResponse;
import com.relaxed.test.http.example.file.FileRequest;
import com.relaxed.test.http.example.file.FileResponse;
import com.relaxed.test.http.example.part.PartRequest;
import com.relaxed.test.http.example.part.PartResponse;
import com.relaxed.test.http.example.query.StampQueryRequest;
import com.relaxed.test.http.example.query.StampQueryResponse;
